...
public class MonsterEggW extends Block {

	protected MonsterEggW() {
        super(Material.rock);
	    //ブロックの特性の設定
	...
	public void onBlockDestroyedByPlayer(World p_149664_1_, int p_149664_2_, int p_149664_3_, int p_149664_4_, int p_149664_5_)
	{
			if (!p_149664_1_.isRemote){
	    	    ...
	    	    EntityWitch entitywitch = new EntityWitch(p_149664_1_);
	            entitywitch.setLocationAndAngles((double)p_149664_2_ + 0.5D, (double)p_149664_3_, (double)p_149664_4_ + 0.5D, 0.0F, 0.0F);
	            p_149664_1_.spawnEntityInWorld(entitywitch);
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
			...
			if(r >= 7){ //30％の確率でモンスターエッグ自身をドロップ
				return Item.getItemFromBlock(AdditionalMonsterEggs.blockMonsterEggW);
			} else {	//70％の確率で丸石をドロップ
