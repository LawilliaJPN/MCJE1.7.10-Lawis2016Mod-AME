...
public class MonsterEggC extends Block {
	...
	public void onBlockDestroyedByPlayer(World p_149664_1_, int p_149664_2_, int p_149664_3_, int p_149664_4_, int p_149664_5_)
	{
	       if (!p_149664_1_.isRemote){
	    	    ...
	    	    EntityCreeper entitycreeper = new EntityCreeper(p_149664_1_);
	            entitycreeper.setLocationAndAngles((double)p_149664_2_ + 0.5D, (double)p_149664_3_, (double)p_149664_4_ + 0.5D, 0.0F, 0.0F);
	            p_149664_1_.spawnEntityInWorld(entitycreeper);
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
			...
			if(r >= 7){ //30％の確率でモンスターエッグ自身をドロップ
				return Item.getItemFromBlock(AdditionalMonsterEggs.blockMonsterEggC);
			} else {	//70％の確率で丸石をドロップ
