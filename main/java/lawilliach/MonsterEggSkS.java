...
public class MonsterEggSkS extends Block {

	protected MonsterEggSkS() {
        super(Material.rock);
	    //ブロックの特性の設定
	...
	//BlockSilverfish.classを参考に、ブロックを壊したときにスケルトン(ソード)を召喚
	...
	public Item getItemDropped(int meta, Random random, int fortune) {
			...
			if(r >= 7){ //30％の確率でモンスターエッグ自身をドロップ
				return Item.getItemFromBlock(AdditionalMonsterEggs.blockMonsterEggSkS);
			} else {	//70％の確率で丸石をドロップ
