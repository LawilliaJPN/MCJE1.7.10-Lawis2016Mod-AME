...
public class RecipesSpawnEggs {
	public RecipesSpawnEggs(){
		//モンスターエッグXのレシピ。（生成される9つのモンスターエッグを1つずつ、不定形レシピ。）
		GameRegistry.addShapelessRecipe(new ItemStack(AdditionalMonsterEggs.blockMonsterEggX),
			       AdditionalMonsterEggs.blockMonsterEggC,
			       AdditionalMonsterEggs.blockMonsterEggSk,
			       AdditionalMonsterEggs.blockMonsterEggSkS,
			       AdditionalMonsterEggs.blockMonsterEggSl,
			       AdditionalMonsterEggs.blockMonsterEggSp,
			       AdditionalMonsterEggs.blockMonsterEggSpC,
			       AdditionalMonsterEggs.blockMonsterEggW,
			       AdditionalMonsterEggs.blockMonsterEggZ,
			       AdditionalMonsterEggs.blockMonsterEggZC
			);
		//モンスターエッグを精錬して、それぞれに対応したスポーンエッグに。(精錬経験値はサボテン、ラピスラズリ相当。)
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggC,new ItemStack(Items.spawn_egg,1,50),0.2f); //クリーパー
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggSk,new ItemStack(Items.spawn_egg,1,51),0.2f); //スケルトン
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggSkS,new ItemStack(Items.spawn_egg,1,51),0.2f); //スケルトン
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggSl,new ItemStack(Items.spawn_egg,1,55),0.2f); //スライム
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggSp,new ItemStack(Items.spawn_egg,1,52),0.2f); //クモ
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggSpC,new ItemStack(Items.spawn_egg,1,59),0.2f); //洞窟グモ
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggW,new ItemStack(Items.spawn_egg,1,66),0.2f); //ウィッチ
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggX,new ItemStack(Items.spawn_egg,1,58),0.2f); //エンダーマン
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggZ,new ItemStack(Items.spawn_egg,1,54),0.2f); //ゾンビ
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockMonsterEggZC,new ItemStack(Items.spawn_egg,1,54),0.2f); //ゾンビ
		//スポーンエッグを利用した追加レシピ
		...
		GameRegistry.addShapelessRecipe(new ItemStack(AdditionalMonsterEggs.blockTNTBlock),
				Blocks.stone,
				new ItemStack(Items.spawn_egg,1,50)
		);
			//TNTブロックを精錬して、火薬2つ(Hard版only)
		GameRegistry.addSmelting(AdditionalMonsterEggs.blockTNTBlock,new ItemStack(Items.gunpowder,2,0),0.1f);
			//スケルトンのSE：骨粉4つ
